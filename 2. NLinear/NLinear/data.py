...
def make_dataset(i, is_val=False, phase=None):
    ...
    # train, val 분리
    if is_val:
        x_train, x_val, y_train, y_val = train_test_split(xdata, ydata, test_size=0.2, shuffle=False, random_state=42)
        x_train, x_val, y_train_ratio, y_train_val = train_test_split(xdata, x_ratio, test_size=0.2, shuffle=False,
                                                                      random_state=42)
