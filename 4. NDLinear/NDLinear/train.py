...
from AIFactory.NDLinear.data import windowDataset
from AIFactory.NDLinear.helper import train_one_epoch, early_stopping
from AIFactory.NDLinear.model import NDLinear
...
for idx in range(0, 37):
    ...
    for epoch in progress:
        ...
        patience, best_loss = early_stopping(val_loss, patience, 0, best_loss, model,
                                             f'models/model_{df_number}.pth')
        if patience >= patiences:  # sota 40
